...
public class CalificacionController {
    ...
    @PatchMapping("/{id}")
    @Operation(summary= "Esta api modificara una calificacion de un baño", description= "Esta api permitira modificar un comentario y calificacion ya creados que se le ha colocado a un baño")
