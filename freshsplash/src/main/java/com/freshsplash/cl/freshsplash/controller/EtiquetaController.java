...
public class EtiquetaController {
    ...
    @GetMapping
    @Operation(summary = "Esta api listara las etiqueta de los baño", description = "Esta api permitira listar las especificaciones concretas de los baños, ya sea si es aptos para discapacitados, es gratuito, si no es gratuito indicara el valor, donde esta ubicado(bencinera, baño publico, tienda, restaurant, etc...)")
